...
+ **[3.1.](#тесты) Шаблон теста** ([Тесты_ШаблонТеста.epf](./SmokeTests/Тесты_ШаблонТеста.epf))
...
Настройки тестов задаются в файле xUnitparams.json ([пример](./SmokeTestsParams/xUnitParams.json)).
