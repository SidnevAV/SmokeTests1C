...
+ **"Префикс"** - Включает/отключает использование теста. Настройка задается свойством "Используется": true/false. Настройка доступна для тестов:

    - **[Тесты_ПроверкаАвтоРегистрацииПлановОбмена](#Тесты_ПроверкаАвтоРегистрацииПлановОбмена)**

<a id="markdown-Настройки_ПрефиксТест" name="Настройки_Префикс"></a>
...
<a id="markdown-Настройки_ПропускатьОбъектыСПрефиксомУдалить" name="Настройки_ПропускатьОбъектыСПрефиксомУдалить"></a>
+ **"Префикс"** - Признак того, что тест будет пропускать объекты с префиксом "Удалить". Настройка задается свойством "ПропускатьОбъектыСПрефиксомУдалить": true/false. Настройка доступна для тестов:
