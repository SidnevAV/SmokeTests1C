...
([Тесты_ПроверкаАвтоРегистрацииПлановОбмена.epf](./SmokeTests/Тесты_ПроверкаАвтоРегистрацииПлановОбмена.epf))
    ...
    + Настройки:
        ...
        - [Отбор по префиксу](#Настройки_ОтборПоПрефиксу)
        - [Пропускать объекты с префиксом удалить](#Настройки_ПропускатьОбъектыСПрефиксомУдалитьТест)
        - [Исключения из проверок](#Настройки_ИсключенияИзПроверок)
...
<a id="markdown-Настройки_ПропускатьОбъектыСПрефиксомУдалитьТест" name="Настройки_ПропускатьОбъектыСПрефиксомУдалить"></a>
