...
Процедура ОбработатьКоллекциюОбъекта(Параметры, ИмяНабораКоллекции, ИмяЭлементаНабора, ИмяЭлементов, ИмяЭлемента)
	...
	Для Каждого ЭлементНабораКоллекции Из ОбъектМетаданных[ИмяНабораКоллекции] Цикл
		...
		ИмяОбъекта = СтрШаблон(ШаблонКоллекции, ОбъектМетаданных.Имя, ИмяЭлементаНабора, ЭлементНабораКоллекции.Имя);
		...
		Если ИмяСодержитПрефикс(ОбъектМетаданных.Имя, ПрефиксОбъектов)
		 Или ИмяСодержитПрефикс(ЭлементНабораКоллекции.Имя, ПрефиксОбъектов) Тогда
			...
			Для Каждого ЭлементКоллекции Из ЭлементНабораКоллекции[ИмяЭлементов] Цикл
				...
				ИмяДляПоиска = СтрШаблон(ШаблонЭлементов, 
				...
				ИмяОбъекта = СтрШаблон(ШаблонЭлементов, 
								ОбъектМетаданных.Имя, 
								ИмяЭлементаНабора, 
								ЭлементНабораКоллекции.Имя, 
								ИмяЭлемента, 
...
Процедура ОбработатьЭлементыОбъекта(Параметры, ИмяКоллекции, ИмяЭлемента, ИмяРодителя = "")
	...
	Для Каждого ЭлементКоллекции Из ОбъектМетаданных[ИмяКоллекции] Цикл
		...
		ИмяОбъекта = СтрШаблон("%1.%2.%3", мИмяОбъекта, ИмяЭлемента, ЭлементКоллекции.Имя);
